...
const PrivacyPolicy = () => {
  return (
    <div className="mx-7 my-7 flex flex-col gap-5">
      <h1 className="font-bold text-xl"> Privacy Policy</h1>
      <p className="text-slate-500"> Last updated: January 31, 2025</p>
      <p>
      ...
      <div>
        ...
        {/* Text of the defination heading */}
        <div className="flex flex-col justify-center gap-3 mt-5">
          ...
          <p>
            ...
            this Agreement) refers to NEXT CONNECT.
          </p>
          <p>
          ...
          <p>
            Website refers to NEXT CONNECT, accessible from
            [www.nextconnecthub.com](www.nextconnecthub.com)
          </p>
          <p>
      ...
      <div className="flex flex-col justify-center gap-3">
        ...
        <p>
          ...
          website](https://www.termsfeed.com/blog/cookies/#What_Are_Cookies)
          article.
        </p>
        <p>
      ...
      <h1 className="font-bold">Use of Your Personal Data</h1>
      <div className="flex flex-col justify-center gap-3">
      ...
      <div className="flex flex-col gap-3">
        <h1 className="font-bold">Retention of Your Personal Data</h1>
        <p>
      ...
      <div className="flex flex-col justify-center gap-3">
        <h1 className="font-bold">Transfer of Your Personal Data</h1>
        <p>
      ...
      <h1 className="font-bold">Disclosure of Your Personal Data</h1>

      <div className="flex flex-col gap-3">
        <h1 className="font-bold">Business Transactions</h1>
        <p>
      ...
      <div className="flex flex-col gap-3">
        <h1 className="font-bold">Law enforcement</h1>
        <p>
      ...
      <div className="flex flex-col gap-3">
        <h1 className="font-bold">Other legal requirements</h1>
        <p>
      ...
      <div className="flex flex-col justify-center gap-3">
        <h1 className="font-bold">Security of Your Personal Data</h1>
        <p>
      ...
      <div className="flex flex-col justify-center gap-3">
        <h1 className="font-bold">Links to Other Websites </h1>
        <p>
      ...
      <div className="flex flex-col justify-center gap-3">
            ...
            <p>By email: nextconnecthub@gmail.com</p>
      </div>
    </div>
  );
};
