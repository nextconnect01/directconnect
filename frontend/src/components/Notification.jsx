  ...
  const markOneNotification = async (notificationId) => {
    try {
      const res = await axios.get(
        `${backendUri}/api/v1/notification/markSingleNotification/${notificationId}`,
  ...
  const deleteOneNotification = async (notificationId) => {
    try {
      const res = await axios.delete(
        `${backendUri}/api/v1/notification/deleteSingleNotification/${notificationId}`,
        { withCredentials: true }
      );
      if (res.data.success) {
