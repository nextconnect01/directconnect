...
const DialogClientsChat = ({open,setOpen,otherUserId}) => {
  ...
  <DialogContent>
    <DialogHeader>
      ...
      <DialogDescription>
        This action cannot be undone. This will permanently delete all your chats with this freelancers
        and remove your data from our servers.
      </DialogDescription>
       <div className='flex justify-center gap-10'>
              <Button onClick={() => {dispatch(removeUserContact(otherUserId)); dispatch(setSelectedUser(null)); deleteConversation}} variant = "outline" className="bg-blue-600 text-white">Yes</Button>
